...
uint8_t create_string_of_1s_at_left(uint8_t num_1s) {
	...
	return (0xff << (8 - num_1s));  // TODO: replace this with a one-line implementation of this function.
}
...
uint8_t set_left_bits(uint8_t byte, uint8_t num_bits_to_set) {
	...
	return create_string_of_1s_at_left(num_bits_to_set) | byte;  // TODO: replace this with a one-line implementation of this function.
}
...
uint8_t set_right_bits(uint8_t byte, uint8_t num_bits_to_set) {
	...
	return create_string_of_1s_at_right(num_bits_to_set) | byte;// TODO: replace this with a one-line implementation of this function.
}
...
uint8_t unset_left_bits(uint8_t byte, uint8_t num_bits_to_unset) {
	...
	return create_string_of_1s_at_left(num_bits_to_unset) ^ byte;  // TODO: replace this with a one-line implementation of this function.
...
uint8_t unset_right_bits(uint8_t byte, uint8_t num_bits_to_unset) {
	...
	return create_string_of_1s_at_right(num_bits_to_unset) ^ byte;  // TODO: replace this with a one-line implementation of this function.
}
...
uint8_t toggle_left_bits(uint8_t byte, uint8_t num_bits_to_toggle) {
	...
	return  (create_string_of_1s_at_left(num_bits_to_toggle) ^ byte)  ;  // TODO: replace this with a one-line implementation of this function.
}

uint8_t toggle_right_bits(uint8_t byte, uint8_t num_bits_to_toggle) {
	// Examples:
	// ∙ toggle_right_bits(11111111₂, 2) would return 11111100₂.
	// ∙ toggle_right_bits(11110101₂, 4) would return 11111010₂.

	return  (create_string_of_1s_at_right(num_bits_to_toggle) ^ byte) ;  // TODO: replace this with a one-line implementation of this function.
}
...
void print_bits(uint8_t bits) {
	...
	for (int i = 1 << 7; i > 0; i /= 2) {
		((bits & i) != 0x00 )?fputc('1', stdout):fputc('0', stdout);
	}
}
